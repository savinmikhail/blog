...
Чем больше проверок в пайплайне, тем медленнее вносятся изменения в код, поэтому не рекомендую затаскивать все возможные инструменты сразу. Вдобавок многие инструменты имеют функционал baseline
