...
Статья нацелена в первую очередь на PHP backend-разработчиков уровня junior/middle, чтобы познакомить с теорией, 
которую спрашивают на собеседованиях, и с практическими примерами/советами, полезными для разработки
...
По крайней мере, вы точно знаете, что GET-запрос на такой-то эндпоинт не завершится с исключением в самом базовом сценарии.
...
Здесь же хочу сказать, что использование конструкций `if` в вашем тесте, как правило, говорит о том, что он плохо написан
